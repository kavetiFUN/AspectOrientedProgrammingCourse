...
/**
 * Manages information about an employee of the company
 */
public class Employee {
	...
	/* Get formatted full name of the employee */
	...
	/* Get employee sex (see constants) */
	public int getSex() {
		return _sex;
	}
	
	/* Get employee role in the company (see constants) */
	public int getRole() {
		return _role;
	}
	
	/* Get employee deparment (can be null) */
	...
	/* Set employee role in the company */
